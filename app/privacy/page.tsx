export default function privacy(){
    return(
        <div className="relative min-h-screen pl-2 pr-2 leading-relaxed text-zinc-800">
       

        <div>

            <div className='relative m-4 mt-3 max-w-3xl pt-3 sm:m-4 lg:m-auto'>
                <h1 className='"mb-3 mt-2 text-2xl font-extrabold leading-6"'>Privacy Policy</h1>
                ...
                <h2 className="mb-3 mt-2 text-2xl font-extrabold leading-6">Interpretation</h2>
                ...
                <h2 className="mb-3 mt-2 text-2xl font-extrabold leading-6">Definitions</h2>
                ...
                <ul>
                    ...
                    <li>
                        <p><strong>Affiliate Links</strong>
                            The links in the shop redirect you to our partners that are resellers of these products. When you click on the affiliate link in our shop and buy a product, the resellers give us a small commission for the recommendation. As our user, you financially support our company with your new acquisition. The affiliate partner gets data from you as you sign up on their website. Through cookies, the ZnapAI website gives the necessary information to the affiliate partner that a member/visitor of ZnapAI used an affiliate link.
                        </p>
                    </li>

                    <li>
                        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
                            &quot;Our&quot; in this Agreement) refers to ZnapAI.</p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p><strong>Website</strong> refers to ZnapAI, accessible from <a href="https://ZnapAI.com"
                            rel="external nofollow noopener" target="_blank">ZnapAI.com</a></p>
                    </li>
                    <li>
                ...
                <h2 className="mb-3 mt-2 text-2xl font-extrabold leading-6">Types of Data Collected</h2>
                <h3 className="mb-3 mt-2 text-2xl font-extrabold leading-6">Personal Data</h3>
                ...
                <h3 className="mb-3 mt-2 text-2xl font-extrabold leading-6">Usage Data</h3>
                ...
                <h3 className="mb-3 mt-2 text-2xl font-extrabold leading-6">Information from Third-Party Social Media Services</h3>
                ...
                <p>You may also have the option of sharing additional information with the Company through Your Third-Party Social Media
                    ...
                    In addition, if you sign in with Google, we will also receive your Google username for personalisation purposes. Note that we do not store any password data and our staff works on a strictly need-to-know basis and have received proper training to deal with your personal data.
                </p>


                <h3 className="mb-3 mt-2 text-2xl font-extrabold leading-6">
                    Web/Mobile App analytics
                </h3>
                <p>

                    The App uses an analytics tool to collect usage data that will help us improve the App for you. The analytics are build on top of Google Analytics and PostHog analytics, and the service collects information such as device type, session duration, in-app purchases, and geography.
                </p>
                ...
                <h3 className="mb-3 mt-2 text-2xl font-extrabold leading-6">Tracking Technologies and Cookies</h3>
                ...
                <h2 className="mb-3 mt-2 text-2xl font-extrabold leading-6">Use of Your Personal Data</h2>
                ...
                <h2 className="mb-3 mt-2 text-2xl font-extrabold leading-6">Retention of Your Personal Data</h2>
                ...
                <h2 className="mb-3 mt-2 text-2xl font-extrabold leading-6">Transfer of Your Personal Data</h2>
                ...
                <h2 className="mb-3 mt-2 text-2xl font-extrabold leading-6">Delete Your Personal Data</h2>
                ...
                <p>Please note, however, that We may need to retain certain information when we have a legal obligation or lawful basis
                    to do so.</p>
                <h2 className="mb-3 mt-2 text-2xl font-extrabold leading-6">Disclosure of Your Personal Data</h2>
                <h3 className="mb-3 mt-2 text-2xl font-extrabold leading-6">Business Transactions</h3>
                ...
                <h3 className="mb-3 mt-2 text-2xl font-extrabold leading-6">Law enforcement</h3>
                ...
                <h3 className="mb-3 mt-2 text-2xl font-extrabold leading-6">Other legal requirements</h3>
                ...
                <h2 className="mb-3 mt-2 text-2xl font-extrabold leading-6">Security of Your Personal Data</h2>
                ...
                <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You
                    ...
                    Some of the links may be affiliates links to our partner merchants and we may earn a commission if you make a purchase from those links.
                    We strongly advise You to review the Privacy Policy of every site You
                    visit.</p>
                <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third
                    party sites or services.</p>

                <h1>Some of the content of this appplication might be intellectual property of someone else  </h1>
                <h3 className="mb-3 mt-2 text-2xl font-extrabold leading-6">If you think that someone is not credited of their work or believe that some copyright infringement is taking place</h3>
                <p>You may contact us</p>
                <ul>
                    <li>
                        <p>By email: contact@znap.in</p>
                    </li>
                ...
                <h3 className="mb-3 mt-2 text-2xl font-extrabold leading-6">Contact Us</h3>
                <p className="mt-2">
                If you have any questions or suggestions about our Terms or Privacy Policy, do not hesitate to contact us at{' '}
                <a className="border-b-[1px] border-black pb-[1px]" href="mailto:contact@znap.in">
                    contact@znap.in
                </a>
            </p>
